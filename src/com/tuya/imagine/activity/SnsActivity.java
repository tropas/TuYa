...
public class SnsActivity extends BaseActivity implements OnClickListener {
    ...
    public void shareMore(File newPath) {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(SnsActivity.this);
        final ShareToAppListAdapter chooseAppAdapter = new ShareToAppListAdapter(SnsActivity.this, "", Uri.fromFile(newPath));
        alertDialog.setAdapter(chooseAppAdapter, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                SnsActivity.this.startActivity((Intent) chooseAppAdapter.getItem(which));
            }
        }).show();
    }
